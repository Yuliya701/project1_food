...
function calculation() {
    ...
    function calcTotal() {
        if (!sex || !height || !weight || !age || !ratio) {
            resultKkal.textContent = '____';
            return;
        }

        if (sex === 'female') {
            resultKkal.textContent = Math.round((447.6 + (9.2 * weight) + (3.1 * height) - (4.3 * age)) * ratio);
        } else {
            resultKkal.textContent = Math.round((88.36 + (13.4 * weight) + (4.8 * height) - (5.7 * age)) * ratio);
        }
    };
...
/*!**************************!*\
  !*** ./src/js/script.js ***!
  \**************************/
const calculation = __webpack_require__(/*! ./modules/calculation */ "./src/js/modules/calculation.js");

window.addEventListener('DOMContentLoaded', () => {
    const tabs = __webpack_require__(/*! ./modules/tabs */ "./src/js/modules/tabs.js"),
    calculation = __webpack_require__(/*! ./modules/calculation */ "./src/js/modules/calculation.js"),
    cards = __webpack_require__(/*! ./modules/forms */ "./src/js/modules/forms.js"),
